...
export function BriefcaseIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} aria-hidden="true" focusable="false" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function CheckIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} aria-hidden="true" focusable="false" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
